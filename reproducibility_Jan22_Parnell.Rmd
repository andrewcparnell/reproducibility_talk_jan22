...
- The impacts of predator/prey removal and the new <span style="color:yellow">EU Common Fishery policy</span>, 
...
# Part 3: 5 pieces of advice {data-background=https://github.com/andrewcparnell/reproducibility_talk_jan22/raw/main/img/advice.png data-background-size=cover}
...
1. Make it <span style="color:red">open access</span> (pretty much compulsory these days)
2. Make it so that people (especially you) can <span style="color:green">re-create your graphs</span>
3. Make it so that they can <span style="color:blue">generalise your code</span>
...
# <span style="color:pink">4. Write better comments in your code (but nobody writes good comments</span>) {data-background=https://github.com/andrewcparnell/reproducibility_talk_jan22/raw/main/img/code.png data-background-size=cover}
...
1. <font size="6">IAll journals requiring code/data that runs and <span style="color:red">open-source</span> reproduces the figures</font>
